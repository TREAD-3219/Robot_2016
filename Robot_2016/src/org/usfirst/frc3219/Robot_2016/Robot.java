...
public class Robot extends IterativeRobot {
    ...
    public void autonomousInit() {
        ...
        String whichAutoCommand = (String) Robot.oi.AutoDefenseChooser.getSelected();
		if (whichAutoCommand.equalsIgnoreCase("Rough Terrain")) {
			autonomousCommand = new RoughTerrain();
		} else if (whichAutoCommand.equalsIgnoreCase("Rock Wall")) {
			autonomousCommand = new RockWall();
		} else if (whichAutoCommand.equalsIgnoreCase("Portcullis")) {
			autonomousCommand = new Portcullis();
		} else if (whichAutoCommand.equalsIgnoreCase("Moat")) {
			autonomousCommand = new Moat();
		} else if (whichAutoCommand.equalsIgnoreCase("Ramparts")) {
			autonomousCommand = new Ramparts();
		} else if (whichAutoCommand.equalsIgnoreCase("Sally Port")) {
			autonomousCommand = new SallyPort();
		} else if (whichAutoCommand.equalsIgnoreCase("Drawbridge")) {
			autonomousCommand = new Drawbridge();
		} else if (whichAutoCommand.equalsIgnoreCase("Chival de Frise")) {
			autonomousCommand = new ChivalDeFrise();
		} else {
			System.out.println("Error: Bad chooser string for whichAutoCommand");
		}*/
