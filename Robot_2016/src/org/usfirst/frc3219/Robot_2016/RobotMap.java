...
public class RobotMap {
	...
	//public static Jaguar driveRightDriveBack;
	public static Jaguar driveLeftDrive;
	//public static Jaguar driveLeftDriveBack;
	public static RobotDrive driveDriveMotors;

	public static Jaguar driveRollerMotorController;
	public static Jaguar driveMultiToolMotor1;
	public static Jaguar driveMultiToolMotor2;
	...
	public static void init() {
		try {
			driveRightDrive = new Jaguar(1);// these might be wrong
			driveLeftDrive = new Jaguar(0);

			//driveLeftDriveFront = new Jaguar(1);
			//driveLeftDriveBack = new Jaguar(2);
...
//			driveDriveMotors.setInvertedMotor(RobotDrive.MotorType.kRearLeft, true);
			...
			//climberSpeed_Controller_12 = new CANJaguar(11);
			...
			System.out.println("ERROR ON THE CANJAGS: " + e.getMessage());
		}
