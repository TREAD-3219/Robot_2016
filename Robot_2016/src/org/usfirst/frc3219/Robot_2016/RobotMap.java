...
public class RobotMap {
	...
	public static void init() {
		try {
			...
			System.out.println("failed to initialize CANJags: " + e.getMessage());
		}

		driveDriveMotors = new RobotDrive(driveLeftDriveFront, driveLeftDriveBack, driveRightDriveFront,
				driveRightDriveBack);
