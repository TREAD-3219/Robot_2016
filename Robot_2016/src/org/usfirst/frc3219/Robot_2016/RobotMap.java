...
public class RobotMap {
    ...
    public static void init() {
    	driveRightDriveFront = new CANJaguar(4);// these might be wrong
    	driveRightDriveBack = new CANJaguar(5);
    	
    	driveLeftDriveFront = new CANJaguar(6);
    	driveLeftDriveBack = new CANJaguar(7);
    	
    	driveDriveMotors = new RobotDrive(driveLeftDriveFront, driveLeftDriveBack, driveRightDriveFront, driveRightDriveBack);
    	
    	driveRollerMotorController = new CANJaguar(8);
    	
    	driveMultiToolMotor1 = new CANJaguar(9);
    	driveMultiToolMotor2 = new CANJaguar(10);
        ...
        feedMechSpeed_Controller_6 = new CANJaguar(6);
        ...
        climberSpeed_Controller_12 = new CANJaguar(12);
