...
public class RobotMap {
	...
	public static double wheelDiameter; //THIS VALUE WILL NEED TO BE CHANGED
	...
	public static void init() {
		try {
			...
			//Encoders
			wheelDiameter = 7.5; //TODO make this more accurate
			distancePerPulse = (2 * Math.PI * (7.5 / 2)) / 360;
