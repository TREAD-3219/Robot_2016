...
public class Navigation extends Subsystem{
	...
	public double findLidarPositionY() {
		double distanceFromWall = 0.0; //need to find distance using triangulation
	...
	public double findLidarPositionX() {
		...
		double lidar4 = sensors.readLidar1(); // these will maybe be added later?
		int C = 45;
	...
	public boolean checkDeadRecAngle() {
		...
		if (Math.abs(deadRecAngle/* - compass*/) <= 5.0) { //compass will be added from Robot.sensors
